...
export default function HeroSection() {
  ...
  const [productName, setProductName] = useState('Dimsum Ori');
  ...
  useEffect(() => {
    ...
    // Wait for GSAP to load, then for preloader to finish
